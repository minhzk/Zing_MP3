...
const SongItem = ({thumbnail, title, artistsNames, sid, releaseDate, order, percent, style, size, song}) => {
  ...
  return (
    ...
    className={`w-full flex-auto p-[10px] flex rounded-md cursor-pointer justify-between items-center ${style || 'hover:bg-main-200'}`}>
        <div className='flex items-center'>
          ...
          <img src={thumbnail} alt="thumbnail" className={`mr-[10px] ${size || 'w-[60px] h-[60px]'} object-cover rounded-md`}/>
