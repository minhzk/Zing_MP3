...
import { handleNumber, formatNumber } from '../../utils/fn'
import { useParams } from 'react-router-dom'
import { apiGetArtist } from '../../apis'
import icons from '../../utils/icons'

const {IoIosPlay, AiOutlineUserAdd} = icons
...
const Singer = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center w-full mb-[400px]'>
